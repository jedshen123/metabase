...
(defn- instance-settings
  ...
  {:version                              (config/mb-version-info :tag)
   ...
   :appearance_site_name                 (not= (appearance/site-name) "Momcozy")
   :appearance_help_link                 (appearance/help-link)
   :appearance_logo                      (not= (appearance/application-logo-url) "app/assets/img/logo.png")
   :appearance_favicon                   (not= (appearance/application-favicon-url) "app/assets/img/favicon.png")
